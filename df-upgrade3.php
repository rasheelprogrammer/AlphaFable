...
<form name="Form1" method="post" id="Form1">
    ...
    <div id="panelForgot" class="panelMsg" style="width:525px;text-align:center;background-color:#FFFF99;">
        <table width="95%" border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
                <td colspan="2" class="tdFormHead style3 server" style="background-color:#530000; color: #FFF;">Upgrade
                    Character
                </td>
            </tr>
                ...
                <td class="tdFormCell">
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <table style="visibility: hidden;">
                            <tr>
                                <td><input type="hidden" name="on0" value="Upgrade">Upgrade</td>
                            </tr>
                            <tr>
                                <td><select name="os0">
                            ...
                            <tr>
                                <td><input type="hidden" name="on1" value="Character ID">Character ID</td>
                            </tr>
                            <tr>
                                <td><input type="text" name="os1" maxlength="200" value="<?php echo $CharID; ?>"></td>
                            </tr>
                        </table>
                        <input type="hidden" name="currency_code" value="AUD">

                        <input type="image" src="images/button-buy.gif" border="0" name="submit"
            ...
            <tr align="left" valign="top" class="tdFormCell">
                ...
                <td class="tdFormCell">
                    <p align="left"><strong class="style16">Special Offer! </strong><br>
                        Take advantage of this opportunity to upgrade your <span class="style6">ENTIRE ACCOUNT</span>!
                        Yes, this is <span class="style6">a one time payment</span> and the best, long-term gaming fun
                        you can get on the internet.</p>
                    <div align="left">
                        <ul>
                            ...
                            <li class="style9">Use DragonAmulet items!</li>
                            <li class="style9">Re-color your Armor</li>
                            <li class="style9">200 Dragon Coins per character (this is the only purchase of Dragon Coins
                                that will apply to all characters)
                            </li>
                            <li class="style9">Support the growth of the Game</li>
                            <li class="style9">One time fee!</li>
                        </ul>
                        ...
                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                            ...
                            <table style="visibility: hidden;">
                                ...
                                <tr>
                                    <td><input type="text" name="os1" maxlength="200" value="<?php echo $CharID; ?>">
                                    </td>
                                </tr>
                            </table>
                            <input type="hidden" name="currency_code" value="AUD">
            ...
            <tr>
                <td colspan="2" class="tdFormHead style3 server" style="background-color:#530000; color: #FFF;">Doom
                    Knight Complete!
                </td>
            </tr>
            <tr align="left" valign="top" class="tdFormCell">
                <td class="tdFormCell">
                    <br>
                    <img src="images/Icon-DoomKnight0004.jpg" alt="Doom Knight Complete!" width="200" height="200"
                         border="0" vspace="12" align="left">
                </td>
                ...
                <td class="tdFormCell">
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <table style="visibility: hidden;">
                            ...
                            <tr>
                                <td><select name="os0">
                                        <option value="Doomknight Character Upgrade">Doom Knight Character Upgrade
                                            $15.00 AUD
                                        </option>
                                    </select></td>
                            </tr>
            ...
            <tr>
                <td colspan="2" class="tdFormHead style3 server" style="background-color:#530000; color: #FFF;">Dragon
                    Coins Mega Pack
                </td>
            </tr>
            <tr align="left" valign="top" class="tdFormCell">
